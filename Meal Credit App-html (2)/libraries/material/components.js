...
prx.types.material_checkbox = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="check-container" data-clickable="true"><div class="check short '+((_active != '') ? 'liveUpdate-checkColor-background-color changeProperty-checkColor' : '')+'"></div><div class="check long '+((_active != '') ? 'liveUpdate-checkColor-background-color changeProperty-checkColor' : '')+'"></div></div>';
		cR += '</label>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
        ...
        ,editableProperties: [
            {
                ...
                ,changeProperty: {
                    ...
                    property: 'text',
                    selector: '.material-dropdown-item span, .material-dropdown-active-value',
                    transitionable: false
                }
            }
        ]
