    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savePost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    json.put("asking_price", price); json.put("location", location); json.put("user_id", "5");
        ...
        String timePick = (hour % 13) + ":" + minuteStr + " " + relation;
        ...
        mTimeSetListener1 = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int hour, int minute) {
                ...
                tv_time1.setText((hour % 13) + ":" + minuteStr + " " + relation);
            }
        };
        ...
        mTimeSetListener2 = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int hour, int minute) {
                String relation = hour > 12 ? "PM" : "AM";
                String minuteStr = minute < 10 ? "0" + minute : Integer.toString(minute);
                tv_time2.setText((hour % 13) + ":" + minuteStr + " " + relation);
            }
        };
    }
}
